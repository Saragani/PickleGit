...
- If a ticket ID is provided, fetch it via the pkl:fetch-ticket skill using the Skill tool.
- If the skill pkl:fetch-ticket already run, use the existing context.
